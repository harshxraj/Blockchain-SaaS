const socialIcons = [
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className="size-5 fill-zinc-500">
  ...
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" className="size-5 fill-zinc-500">
        {/* <!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--> */}
